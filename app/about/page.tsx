            ...
            <div className='w-full'>
                <section className='lg:w-full w-[93%]  lg:max-w-[1450px] mx-auto mt-[30px] lg:mt-[50px] '>
                    ...
                    <section className='mt-[52px] '>
                        <h1 className='text-[40.78px] leading-[53px] lg:text-[96px] lg:leading-[124.8px] text-[#1B1C1E] lg:w-[811px] mx-auto '  data-aos="fade-up"><i className='font-light text-[#28292c]'  data-aos="fade-up">Story</i>  of the mythic dragons </h1>
                        <div className='flex'>
                            <NavigationMenu />
                        <div className='content video-container mt-[15px] lg:mt-[30px] w-fit mx-auto '  data-aos="fade-down">
                            <video loop className="lg:w-[1106px] object-cover lg:h-[300px] h-[209px] w-[380px] " autoPlay muted>
                                <source src="/samura.mp4" type="video/mp4" />
                            </video>
                        </div>
                        </div>
                        <div className='mt-[20px] md:flex justify-between w-full lg:w-[80%] mx-auto lg:ml-[15.9%] '>
                            ...
                            <div className='text-[#1B1C1E] text-[15px] leading-[19.5px] mt-[15px] md:mt-[0px] lg:text-[25px] lg:leading-[32.5px] lg:w-[725px] 'data-aos="fade-up" data-duration="1500">
