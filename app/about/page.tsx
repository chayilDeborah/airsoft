            ...
            <div className='w-full'>
                <section className='lg:w-full w-[93%]  lg:max-w-[1450px] mx-auto mt-[30px] lg:mt-[50px] '>
                    ...
                    <section className='mt-[52px] '>
                        ...
                        <div className='flex'>
                            <NavigationMenu />
                        <div className='content video-container mt-[15px] lg:mt-[30px] w-fit mx-auto '>
                        ...
                        <div className='mt-[30px] mb-[100px] md:my-[100px] mx-auto grid grid-cols-2 md:grid-cols-3 lg:w-[924px] text-[#1B1C1E]'>
                            <section className='w-[165px] lg:w-[288px] mx-auto lg:mx-[0px] rounded-[18.75px] lg:rounded-[30px] border-[1.88px] md:border-[3px] border-[#D9D9D9] pt-[24px] lg:pt-[39px] pl-[21px] lg:pl-[35px] '>
                            ...
                            <section className='w-[165px] lg:w-[288px] mx-auto lg:mx-[0px] rounded-[18.75px] lg:rounded-[30px] border-[1.88px] md:border-[3px] border-[#D9D9D9] pt-[24px] lg:pt-[39px] pl-[21px] lg:pl-[35px] lg:mt-[0px] mt-[18px] '>
