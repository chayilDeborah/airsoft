    ...
    <main  className='lg:max-w-[1450px] w-[93%] mx-auto lg:w-full'>
        ...
        <section className='flex justify-center mt-[52px] mb-[60px] '>
            ...
            <div>
                ...
                <div className='flex'>
                    <h1 className='lg:text-[96px] lg:leading-[124.8px] text-[31.6px] leading-[42.4px] text-[#1B1C1E] lg:w-[811px] w-[329px] '><i className='font-light text-[#28292c]'>Leading</i> Fantasy Concept Art Studio</h1>
            ...
            <div className='lg:flex justify-between mt-[15px] lg:mt-[27px] '>
                <Image src={superwoman} alt='superwoman' className='lg:w-[511px] lg:h-[304px] w-[334px] mx-auto lg:mx-[0px] ' />
