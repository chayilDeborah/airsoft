                    ...
                    <section>
                        <div className='bg-[#000000] text-[#FFFFFF] rounded-[22.3px] lg:rounded-[30px] lg:w-[511px] pl-[29px] lg:pl-[0px] py-[32px] lg:py-[70px] '>
                            <div className='w-[301px] lg:mx-auto'>
                                ...
                                <button className='mt-[29.7px] border-[1.54px] border-[#F5F5F5] rounded-[25.74px] w-[132.7px] h-[52px] lg:text-[15.4px] text-[] leading-[] lg:leading-[20px] lg:text-[#F5F5F5]  overflow-hidden relative group '>
