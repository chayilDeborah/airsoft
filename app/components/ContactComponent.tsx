    ...
    return (
        <main className='flex justify-center mt-[2px] mb-0px] pb-[50px] lg:pb-[150px] overflow-hidden ' id='contact' >
            <section className='lg:max-w-[1450px] w-[93%] lg:w-full mx-auto '>
                <Image src={unlockdesk} alt='unlock' className='hidden lg:block w-[76%] mx-auto '  data-aos="fade-out"/>
                <Image src={unlockmob} alt='unlock' className='lg:hidden block w-[94%] mx-auto ' data-aos="fade-out"/>
